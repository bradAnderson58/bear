...
BasicGame.canada1 = function (game) {
...
BasicGame.canada1.prototype = {
    ...
    create: function() {
		...
		player = this.add.sprite(1000,25300,'car');
		...
		finish = this.add.sprite(170,0,'finish');
