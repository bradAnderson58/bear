...
BasicGame.main.prototype = {
    ...
    create: function() {
		this.world.setBounds(0, 0, 3200, 12800);
		this.stage.backgroundColor = '#001f00';
		map = this.add.sprite(0,0,'road');
		
		finish = this.add.sprite(575,0,'finish');
		tiles = this.add.tilemap('map1');
		...
		player = this.add.sprite(1200,12750,'car');
		...
		cop1 = this.add.sprite(1000, 12750, 'police');
    ...
    update: function() {
		 ...
		 this.physics.collide(player, finish, this.endGame, null, this);
